    ...
    connectedCallback() {
        ...
        <div class="container">
            <div class="social-media">
                <ul>
                    <li>
                        <a target="_blank" href="https://www.behance.net/layrsstudio">
                            <img src="./assets/icons/behance.svg" alt="behance.lynqStudio">
                        </a>
                    </li>
                    <li>
                        <a target="_blank" href="https://www.instagram.com/lynq.studio.3d/">
                            <img src="./assets/icons/instagram.svg" alt="instagram.lynqStudio">
                        </a>
                    </li>
                    <li>
                        <a target="_blank" href="https://shorturl.at/44F9e">
                            <img src="./assets/icons/facebook.svg" alt="facebook.lynqStudio">
                        </a>
                    </li>
                    <li>
                        <a target="_blank" href="https://shorturl.at/pXWif">
